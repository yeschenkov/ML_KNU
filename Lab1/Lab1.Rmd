...
barplot(total_emissions$Emissions,names.arg = total_emissions$year, xlab = "Year", ylab = "Total Emissions")
```

**Answer:  Total emissions from PM2.5 have decreased in the United States from 1999 to 2008.**
...
**Answer: Total emissions from PM2.5 have decreased in the Baltimore City from 1999 to 2008**
...
**Answer: Non-road, Nonpoint, on-road types of sources have seen decreases in emissions. Point type source has slightly increased in emissions.**
...
** Answer: Los Angeles County has seen greater changes in motor vehicle emissions **
